...
function updateCommitTable(commitData) {
    $('#commit-table').DataTable({
        ...
        initComplete: function () {
            $('#commit-table_wrapper .datatable-header').css({
                'background-color': '#f0f7ff',
                'margin-bottom': '10px'
            });

            $('#commit-table_wrapper .dataTables_filter input').css({
            ...
            $('#commit-table_wrapper .datatable-footer').css({
                'padding-top': '10px'
            });

            $('#commit-table thead th').css({
            ...
            $('#commit-table thead th:last-child').css('border-right', 'none');
        },
        ...
        drawCallback: function () {
            $('#commit-table tbody tr').each(function (index) {

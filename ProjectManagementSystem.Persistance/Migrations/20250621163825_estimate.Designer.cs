...
namespace ProjectManagementSystem.Persistance.Migrations
{
    ...
    [Migration("20250621163825_estimate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManagementSystem.Domain.Entities.Estimate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ProjectManagementSystem.Domain.Entities.Estimate", b =>
                {
                    b.HasOne("ProjectManagementSystem.Domain.Entities.Project", "Proje")
                        .WithMany("Estimates")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
